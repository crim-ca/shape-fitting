...
do
	...
	$CYLINDER_TEST_EXEC \
		$DATASET_DIR $ANGLE_BINS $RADIUS_BINS $POSITION_BINS $ORIENTATION_ACCUMULATORS_NUM $GAUSSIAN_SPHERE_POINTS_NUM \
		$ACCUMULATOR_PEAK_THRESHOLD $MIN_RADIUS $MAX_RADIUS $RADIUS_VALUES \
		$NORMAL_DISTANCE_WEIGHT $MAX_ITERATIONS $DISTANCE_THRESHOLD $DO_REFINE $VISUALIZE
done
